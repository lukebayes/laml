...
Sprout::ProjectModel.setup do |model|
  ...
  model.language      = 'as3'
  model.output        = "#{model.bin_dir}/LAML.swf"
  model.test_output   = "#{model.bin_dir}/LAMLRunner.swf"
end
...
#  t.gem_name                  = 'sprout-flex3sdk-tool'
  ...
  t.input                     = "#{model.src_dir}/LAMLRunner.as"
